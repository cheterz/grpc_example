...
import 'cheterz.pb.dart' as $0;
export 'cheterz.pb.dart';

class cheterzClient extends $grpc.Client {
  ...
  cheterzClient($grpc.ClientChannel channel,
...
abstract class cheterzServiceBase extends $grpc.Service {
  $core.String get $name => 'cheterz';
